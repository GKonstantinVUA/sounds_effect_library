(() => {
        ...
        window.addEventListener("load", (function(e) {
            ...
            function getHeight(showMoreBlock, showMoreContent) {
                ...
                if (showMoreType === "items") {
                    const showMoreTypeValue = showMoreContent.dataset.showmoreContent ? showMoreContent.dataset.showmoreContent : 4;
    ...
    tippy_esm(".sound__play-button", {
        content: "Play Track",
        arrow: false
    });
    tippy_esm(".sound__info", {
        content: "Name, Singer, Duration",
        arrow: false
    });
    tippy_esm(".sound__info", {
        content: "Name, Singer, Duration",
    ...
    tippy_esm(".sound__desk-track", {
        content: "Desk",
        arrow: false
    });
    tippy_esm(".sound__genre", {
        content: "Genre",
        arrow: false
    });
    tippy_esm(".action__like", {
        content: "Add to Favorites",
        arrow: false
    });
    tippy_esm(".action__download", {
        content: "Donwload",
        arrow: false
    });
    tippy_esm(".action__more-info", {
        content: "More Info",
        arrow: false
    });
 ...
 //! Припинити виконання, якщо не знайдено необхідні елементи
 ...
 //!Час зникання карток коли вони йдуть вгору. Не задавати значення більше 600! Можливий конфлікт стилів!!!
                                }
            }));
        ...
        //! Оновлення тексту для кнопки
            ...
            showMoreBtn.textContent = itemsShown >= itemArea.length ? "Collapse" : "See more category";
        }
 ...
 //! Затримка перед перекиданням до самої гори
                        } else {
 ...
 //! Затримка перед переходом до наступної картки. При встановленні значення менше '50' йде дотбыжання від швидкості
    ...
    let btnPopup = document.getElementById("btn");
    function openFormRegister() {
        loginPopup.style.left = "-310px";
        registerPopup.style.left = "-310px";
        if (btnPopup) btnPopup.style.left = "120px";
    }
    function openFormLogin() {
        loginPopup.style.left = "0px";
        registerPopup.style.left = "0px";
        if (btnPopup) btnPopup.style.left = "0px";
    }
    window.openFormRegister = openFormRegister;
    window.openFormLogin = openFormLogin;
    document.addEventListener("DOMContentLoaded", (function() {
        setTimeout((() => {
            loginPopup.style.left = "0px";
            registerPopup.style.left = "0px";
